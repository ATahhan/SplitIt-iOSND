...
@IBDesignable class GradientView: UIView {
    ...
    @IBInspectable var shadowColorG: UIColor = UIColor.black {
        didSet {
            setNeedsLayout()
        }
    }
    ...
    @IBInspectable var cornerRadiusG: CGFloat = 0 {
        didSet {
            setNeedsLayout()
        }
    }
    ...
    override func layoutSubviews() {
        ...
        layer.cornerRadius = cornerRadiusG
        layer.shadowColor = shadowColorG.cgColor
